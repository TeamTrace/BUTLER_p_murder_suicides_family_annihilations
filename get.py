...
def get():
    ...
    workflow_name = "murder-suicides-family-annihilations-gl"  # Replace with your workflow name
    notebook_name = "murder-suicides-family-annihilations"  # Replace with your notebook name
